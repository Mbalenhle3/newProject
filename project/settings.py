...
SECRET_KEY = 'django-insecure-wg*)=$x93+ds#7y7gd%q+xta8g(^gttm=^8h_rl^72ncg1n&l1'
...
EMAIL_HOST = 'smtp.gmail.com'  # Use the Gmail SMTP server
EMAIL_PORT = 587               # Use port 587 for TLS
EMAIL_USE_TLS = True           # Enable TLS
EMAIL_HOST_USER = 'qinisomusa18@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'wpgu ltcn qnpb xfwv'      # Your email password (or App Password)
